...
<?php
    ...
    {
        clearContainedFood($_GET["cancel_food"],$_SESSION["user"]);                     //dovrebbe cancellare l'alimento selezionato tramite bottoni, poi fare l'unset per evitare che resti settato
...
<html>
    ...
    <body>
        ...
        <div id = "message"></div>
        <form method="get" id="bottoni" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>"></form>       <!--Serve per inserire i pulsanti all'interno della tabella-->
        <table id="frigo" style="width:100%">
            ...
            <script>
                ...
                for(let i = 0; i<food.length; i++)
                {
                    ...
                    button.form = "bottoni";                                    //scoprire come dare l'input a PHP per passare l'id dell'alimento da cancellare tramite la funzione
                    button.type = "submit";
